...
var registry = map[Agent]Meta{
	...
	Claude: {
		...
		InstallCmd: `RUN npm install -g @anthropic-ai/claude-code@v2.1.212`,
	...
	Codex: {
		Name:       Codex,
		ConfigDir:  ".codex",
		InstallCmd: `RUN npm install -g @openai/codex@v0.144.5`,
	...
	Copilot: {
		Name:       Copilot,
		ConfigDir:  ".copilot",
		InstallCmd: `RUN npm install -g @github/copilot@v1.0.71`,
	...
	OpenCode: {
		Name:       OpenCode,
		ConfigDir:  ".opencode",
		InstallCmd: `RUN npm install -g opencode-ai@v1.18.3`,
