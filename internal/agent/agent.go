...
var registry = map[Agent]Meta{
	Claude: {
		...
		InstallCmd: `RUN npm install -g @anthropic-ai/claude-code@v2.1.138`,
	...
	Codex: {
		Name:       Codex,
		ConfigDir:  ".codex",
		InstallCmd: `RUN npm install -g @openai/codex@v0.130.0`,
	...
	Copilot: {
		Name:       Copilot,
		ConfigDir:  ".copilot",
		InstallCmd: `RUN npm install -g @github/copilot@v1.0.44`,
	...
	Gemini: {
		Name:       Gemini,
		ConfigDir:  ".gemini",
		InstallCmd: `RUN npm install -g @google/gemini-cli@v0.41.2`,
	...
	OpenCode: {
		Name:       OpenCode,
		ConfigDir:  ".opencode",
		InstallCmd: `RUN npm install -g opencode-ai@v1.14.44`,
