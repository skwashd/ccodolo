...
var registry = map[Agent]Meta{
	...
	Codex: {
		Name:       Codex,
		ConfigDir:  ".codex",
		InstallCmd: `RUN npm install -g @openai/codex@v0.125.0`,
	...
	Copilot: {
		Name:       Copilot,
		ConfigDir:  ".copilot",
		InstallCmd: `RUN npm install -g @github/copilot@v1.0.36`,
	...
	Gemini: {
		Name:       Gemini,
		ConfigDir:  ".gemini",
		InstallCmd: `RUN npm install -g @google/gemini-cli@v0.39.1`,
