...
var registry = map[Agent]Meta{
	...
	Claude: {
		...
		InstallCmd: `RUN npm install -g @anthropic-ai/claude-code@v2.1.240`,
	...
	Codex: {
		Name:       Codex,
		ConfigDir:  ".codex",
		InstallCmd: `RUN npm install -g @openai/codex@v0.149.0`,
	...
	OpenCode: {
		Name:       OpenCode,
		ConfigDir:  ".opencode",
		InstallCmd: `RUN npm install -g opencode-ai@v1.18.21`,
