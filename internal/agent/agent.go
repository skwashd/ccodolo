...
var registry = map[Agent]Meta{
	Claude: {
		...
		InstallCmd: `RUN npm install -g @anthropic-ai/claude-code@v2.1.112`,
	...
	Codex: {
		Name:       Codex,
		ConfigDir:  ".codex",
		InstallCmd: `RUN npm install -g @openai/codex@v0.121.0`,
	...
	Copilot: {
		Name:       Copilot,
		ConfigDir:  ".copilot",
		InstallCmd: `RUN npm install -g @github/copilot@v1.0.30`,
	...
	Gemini: {
		Name:       Gemini,
		ConfigDir:  ".gemini",
		InstallCmd: `RUN npm install -g @google/gemini-cli@v0.38.1`,
	...
	OpenCode: {
		Name:       OpenCode,
		ConfigDir:  ".opencode",
		InstallCmd: `RUN npm install -g opencode-ai@v1.4.6`,
