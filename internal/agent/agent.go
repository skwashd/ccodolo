...
var registry = map[Agent]Meta{
	Claude: {
		...
		InstallCmd: `RUN npm install -g @anthropic-ai/claude-code@v2.1.114`,
	...
	Copilot: {
		Name:       Copilot,
		ConfigDir:  ".copilot",
		InstallCmd: `RUN npm install -g @github/copilot@v1.0.32`,
	...
	OpenCode: {
		Name:       OpenCode,
		ConfigDir:  ".opencode",
		InstallCmd: `RUN npm install -g opencode-ai@v1.14.18`,
